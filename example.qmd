...
filters:
  - critic-markup
pdf-engine: latexmk
source-url: https://github.com/mloubout/critic-markup/blob/main/example.qmd
source-description: example file from CriticMarkup repo, copied in to test whether this extension properly handles CriticMarkup syntax
---
